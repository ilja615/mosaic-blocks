...
public class ServerLoginPacketListenerImpl implements ServerLoginPacketListener {
   ...
   public void tick() {
      if (this.state == State.NEGOTIATING) {
         ...
         boolean negotiationComplete = net.minecraftforge.fmllegacy.network.NetworkHooks.tickNegotiation(this, this.connection, this.delayedAcceptPlayer);
   ...
   public void handleCustomQueryPacket(ServerboundCustomQueryPacket p_10045_) {
      if (!net.minecraftforge.fmllegacy.network.NetworkHooks.onCustomPayload(p_10045_, this.connection))
