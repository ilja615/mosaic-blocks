...
public class Potion extends net.minecraftforge.registries.ForgeRegistryEntry<Potion> {
   private final net.minecraftforge.common.util.ReverseTagWrapper<Potion> reverseTags = new net.minecraftforge.common.util.ReverseTagWrapper<Potion>(this, () -> net.minecraft.tags.SerializationTags.getInstance().getOrEmpty(Registry.POTION_REGISTRY));
