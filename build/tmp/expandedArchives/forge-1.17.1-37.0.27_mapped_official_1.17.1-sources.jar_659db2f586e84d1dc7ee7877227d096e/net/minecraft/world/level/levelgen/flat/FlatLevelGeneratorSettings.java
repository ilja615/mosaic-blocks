...
public class FlatLevelGeneratorSettings {
   ...
   public Biome getBiomeFromSettings() {
      ...
      Map<StructureFeature<?>, ConfiguredStructureFeature<?, ?>> map = new java.util.HashMap<>(STRUCTURE_FEATURES);
      net.minecraft.data.BuiltinRegistries.CONFIGURED_STRUCTURE_FEATURE.stream().filter(f -> !map.containsKey(f.feature)).forEach(f -> map.put(f.feature, f));
