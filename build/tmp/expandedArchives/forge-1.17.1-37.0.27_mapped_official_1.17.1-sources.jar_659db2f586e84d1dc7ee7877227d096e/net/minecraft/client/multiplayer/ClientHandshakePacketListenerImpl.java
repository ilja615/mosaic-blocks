...
public class ClientHandshakePacketListenerImpl implements ClientLoginPacketListener {
   ...
   public void handleGameProfile(ClientboundGameProfilePacket p_104547_) {
      ...
      net.minecraftforge.fmllegacy.network.NetworkHooks.handleClientLoginSuccess(this.connection);
   ...
   public void handleCustomQuery(ClientboundCustomQueryPacket p_104545_) {
      if (net.minecraftforge.fmllegacy.network.NetworkHooks.onCustomPayload(p_104545_, this.connection)) return;
