...
public class WorldGenSettingsComponent implements Widget {
   ...
   public void setVisibility(boolean p_170288_) {
      ...
      if (this.settings.isDebug()) {
         ...
         this.customizeTypeButton.visible = p_170288_ && (WorldPreset.EDITORS.containsKey(this.preset) || net.minecraftforge.client.ForgeHooksClient.hasBiomeGeneratorSettingsOptionsScreen(this.preset));
