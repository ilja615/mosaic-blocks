   ...
   public void keyPress(long p_90894_, int p_90895_, int p_90896_, int p_90897_, int p_90898_) {
      if (p_90894_ == this.minecraft.getWindow().getWindow()) {
         ...
         if ((!(this.minecraft.screen instanceof ControlsScreen) || ((ControlsScreen)screen).lastKeySelection <= Util.getMillis() - 20L)) {
            ...
            } else if (p_90897_ == 0 /*GLFW_RELEASE*/ && this.minecraft.screen instanceof ControlsScreen)
         ...
         if (screen != null) {
            ...
            Screen.wrapScreenError(() -> {
               if (p_90897_ != 1 && (p_90897_ != 2 || !this.sendRepeatsToGui)) {
                  if (p_90897_ == 0) {
                     aboolean[0] = net.minecraftforge.client.ForgeHooksClient.onGuiKeyReleasedPre(this.minecraft.screen, p_90895_, p_90896_, p_90898_);
                     if (!aboolean[0]) aboolean[0] = screen.keyReleased(p_90895_, p_90896_, p_90898_);
                     if (!aboolean[0]) aboolean[0] = net.minecraftforge.client.ForgeHooksClient.onGuiKeyReleasedPost(this.minecraft.screen, p_90895_, p_90896_, p_90898_);
                  }
               } else {
                  screen.afterKeyboardAction();
                  aboolean[0] = net.minecraftforge.client.ForgeHooksClient.onGuiKeyPressedPre(this.minecraft.screen, p_90895_, p_90896_, p_90898_);
                  if (!aboolean[0]) aboolean[0] = screen.keyPressed(p_90895_, p_90896_, p_90898_);
                  if (!aboolean[0]) aboolean[0] = net.minecraftforge.client.ForgeHooksClient.onGuiKeyPressedPost(this.minecraft.screen, p_90895_, p_90896_, p_90898_);
               }
      ...
      if (p_90890_ == this.minecraft.getWindow().getWindow()) {
         ...
         if (guieventlistener != null && this.minecraft.getOverlay() == null) {
            if (Character.charCount(p_90891_) == 1) {
               Screen.wrapScreenError(() -> {
                  if (net.minecraftforge.client.ForgeHooksClient.onGuiCharTypedPre(this.minecraft.screen, (char)p_90891_, p_90892_)) return;
                  if (guieventlistener.charTyped((char)p_90891_, p_90892_)) return;
                  net.minecraftforge.client.ForgeHooksClient.onGuiCharTypedPost(this.minecraft.screen, (char)p_90891_, p_90892_);
               }, "charTyped event handler", guieventlistener.getClass().getCanonicalName());
            } else {
               for(char c0 : Character.toChars(p_90891_)) {
                  Screen.wrapScreenError(() -> {
                     if (net.minecraftforge.client.ForgeHooksClient.onGuiCharTypedPre(this.minecraft.screen, c0, p_90892_)) return;
                     if (guieventlistener.charTyped(c0, p_90892_)) return;
                     net.minecraftforge.client.ForgeHooksClient.onGuiCharTypedPost(this.minecraft.screen, c0, p_90892_);
                  }, "charTyped event handler", guieventlistener.getClass().getCanonicalName());
               }
            }
