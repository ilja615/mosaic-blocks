...
public class ItemModelShaper {
   ...
   public TextureAtlasSprite getParticleIcon(ItemStack p_109400_) {
      ...
      return bakedmodel == this.modelManager.getMissingModel() && p_109400_.getItem() instanceof BlockItem ? this.modelManager.getBlockModelShaper().getParticleIcon(((BlockItem)p_109400_.getItem()).getBlock().defaultBlockState()) : bakedmodel.getOverrides().resolve(bakedmodel, p_109400_, null, null, 0).getParticleIcon(net.minecraftforge.client.model.data.EmptyModelData.INSTANCE);
   }
