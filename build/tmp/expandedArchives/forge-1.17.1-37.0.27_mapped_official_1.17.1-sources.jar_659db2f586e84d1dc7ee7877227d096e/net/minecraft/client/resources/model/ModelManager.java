...
public class ModelManager extends SimplePreparableReloadListener<ModelBakery> implements AutoCloseable {
   ...
   protected ModelBakery prepare(ResourceManager p_119413_, ProfilerFiller p_119414_) {
      p_119414_.startTick();
      net.minecraftforge.client.model.ModelLoader modelbakery = new net.minecraftforge.client.model.ModelLoader(p_119413_, this.blockColors, p_119414_, this.maxMipmapLevels);
      p_119414_.endTick();
      return modelbakery;
   }
   ...
   protected void apply(ModelBakery p_119419_, ResourceManager p_119420_, ProfilerFiller p_119421_) {
      ...
      net.minecraftforge.client.ForgeHooksClient.onModelBake(this, this.bakedRegistry, (net.minecraftforge.client.model.ModelLoader) p_119419_);
