...
public class CrashReport {
   ...
   public void getDetails(StringBuilder p_127520_) {
      ...
      if (this.uncategorizedStackTrace != null && this.uncategorizedStackTrace.length > 0) {
         ...
         p_127520_.append(net.minecraftforge.fmllegacy.CrashReportExtender.generateEnhancedStackTrace(this.uncategorizedStackTrace));
      }
      ...
      net.minecraftforge.fmllegacy.CrashReportExtender.extendSystemReport(systemReport);
