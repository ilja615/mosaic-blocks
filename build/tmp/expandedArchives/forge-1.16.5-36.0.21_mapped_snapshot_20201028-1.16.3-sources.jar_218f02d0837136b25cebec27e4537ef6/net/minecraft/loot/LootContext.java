      ...
      public LootContext build(LootParameterSet parameterSet) {
         ...
         if (!set.isEmpty()) {
            ...
            if (!set1.isEmpty()) {
               ...
               return new LootContext(random, this.luck, this.world, minecraftserver.getLootTableManager()::getLootTableFromLocation, minecraftserver.func_229736_aP_()::func_227517_a_, this.lootParameters, this.field_216026_c, this.queriedLootTableId);
            }
         }
      }
   }
